...
public class MapLoader {
    ...
    static {
        ...
        doorMessages.put("puerta_camino_4", "¿Quieres ir al pueblo Deir el-Medina? Pulsa E");
        doorMessages.put("puerta_tumba_dentro", "¿Quieres salir de la tumba KV9? Pulsa E");
    }
